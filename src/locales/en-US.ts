export default {
  ...
  settings: {
    ...
    shortcutsDescription: 'Click a shortcut button, then press a new key combination. Space always advances and Escape always exits fullscreen.',
    shortcutCapture: 'Press shortcut…',
    shortcutConflict: 'Conflicts with another action',
    shortcutSaveBlocked: 'Resolve shortcut conflicts before saving',
    resetShortcuts: 'Restore Default Shortcuts',
    shortcutGroup: { general: 'General', browse: 'Browse', view: 'View', file: 'File' },
    shortcutAction: {
      openFile: 'Open File', openDirectory: 'Open Folder', settings: 'Open Settings',
      reveal: 'Reveal in Finder', copyFile: 'Copy File', delete: 'Move to Trash',
      previous: 'Previous', next: 'Next', zoomIn: 'Zoom In', zoomOut: 'Zoom Out',
      fitWindow: 'Fit Window', actualSize: 'Actual Size', fullscreen: 'Fullscreen',
      rotateClockwise: 'Rotate Clockwise', rotateCounterClockwise: 'Rotate Counterclockwise',
    },
