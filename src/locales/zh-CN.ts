export default {
  ...
  settings: {
    ...
    shortcutsDescription: '点击快捷键按钮后按下新的组合键。Space 始终切换到下一张，Escape 始终退出全屏。',
    shortcutCapture: '按下快捷键…',
    shortcutConflict: '与其他动作冲突',
    shortcutSaveBlocked: '请先解决快捷键冲突后再保存',
    resetShortcuts: '恢复默认快捷键',
    shortcutGroup: { general: '通用', browse: '浏览', view: '查看', file: '文件' },
    shortcutAction: {
      openFile: '打开文件', openDirectory: '打开目录', settings: '打开设置',
      reveal: '在 Finder 中显示', copyFile: '复制文件', delete: '移到废纸篓',
      previous: '上一张', next: '下一张', zoomIn: '放大', zoomOut: '缩小',
      fitWindow: '适应窗口', actualSize: '原始大小', fullscreen: '全屏',
